#!/bin/bash
#SBATCH -J 3dino-inference-ds000-unseen
...
# =========================
# Inference: Dataset000_CZII_10000 (unseen, evaluated with Dataset001 models)
# Uses --input-dir / --label-dir instead of a datalist JSON.
# All 8 Dataset001 model variants (UNETR/ViTAdapter x 100%/10%/50%/full_ft).
# Results saved under {EXP_DIR}/inference_unseen/
# =========================
...
INPUT_DIR="/cluster/projects/bwanggroup/reza/projects/cryoet/datasets/downstream/Dataset000_CZII_10000/imagesTr"
LABEL_DIR="/cluster/projects/bwanggroup/reza/projects/cryoet/datasets/downstream/Dataset000_CZII_10000/labelsTr"
DATASET_NAME="Dataset001_CZII_10001"   # same class scheme as Dataset001 (4-class)
NUM_CLASSES=4
IMAGE_SIZE=112
BATCH_SIZE=1
OVERLAP=0.75
...
for EXP in "${EXPERIMENTS[@]}"; do
    ...
    OUTPUT_DIR="${FINETUNING_DIR}/${EXP}/inference_unseen"
    mkdir -p "$OUTPUT_DIR"
