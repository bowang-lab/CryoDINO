#!/bin/bash
#SBATCH -J cryodino_3dino-ft-b200-128-6249-j4-newaug
...
# — in the LP sweep this dataset favored highres128/6249 over highres112/6249
# by the largest relative margin (~11%) of any dataset, so this is the
# expected best backbone for DS049 specifically.
