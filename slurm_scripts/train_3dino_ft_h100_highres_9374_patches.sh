#!/bin/bash
#SBATCH -J 3dino-ft-patches-pretrain-aug-ext
...
for DATASET_NAME in "${DATASETS[@]}"; do
    ...
    OUTPUT_DIR="${BASE_OUTPUT_DIR}/ssl3d_run_h100_high_res_training_9374_${DATASET_NAME}_vit_adapter_pretrain_aug_ext"
