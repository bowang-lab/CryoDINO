#!/bin/bash
#SBATCH -J 3dino-ft-patches-ds-specific-aug-mix-j4
...
# =========================
# Dataset049_EMPIAR_12049 — mix-patch augmentation + fine-tuning
# Augmentation uses 6 classes (raw patch labels); training remaps to 4 classes
# =========================
...
AUG_DS="Dataset049_EMPIAR_12049_transposed_patches512"
AUG_INPUT="${BASE_DATA_DIR}/Dataset049_EMPIAR_12049_transposed_patches512_100_datalist.json"
AUG_OUTDIR="${DATASETS_DIR}/Dataset049_EMPIAR_12049_transposed_train_patches_512_augmented"
AUG_CLS=6   # raw patches have 6 classes (0-5); remapping to 4 happens in augmentations.py
DATASET_NAME="Dataset049_EMPIAR_12049_transposed_patches512_augmented"
NUM_CLASSES=4
