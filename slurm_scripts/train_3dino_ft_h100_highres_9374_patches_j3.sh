#!/bin/bash
#SBATCH -J 3dino-ft-patches-agg-aug-mix-j3
...
# =========================
# Dataset989_EMPIAR_10989 — mix-patch augmentation + fine-tuning
# =========================
...
AUG_DS="Dataset989_EMPIAR_10989_transposed_patches512"
AUG_INPUT="${BASE_DATA_DIR}/Dataset989_EMPIAR_10989_transposed_patches512_100_datalist.json"
AUG_OUTDIR="${DATASETS_DIR}/Dataset989_EMPIAR_10989_transposed_train_patches_512_augmented"
AUG_CLS=2
DATASET_NAME="Dataset989_EMPIAR_10989_transposed_patches512_augmented"
NUM_CLASSES=2
