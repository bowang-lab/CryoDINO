#!/bin/bash
#SBATCH -J cryodino_3dino-ft-b200-6249-j2
...
# =========================
# Dataset010_CZII_10010 — fine-tuning with ViTAdapterUNETR head.
# Backbone: B200 ssl3d_run_b200_high_res / training_6249 — the best overall LP
# checkpoint from the linear_probing_h100_b200_comparison sweep.
...
DATASET_NAME="Dataset010_CZII_10010_patches512"
NUM_CLASSES=2
