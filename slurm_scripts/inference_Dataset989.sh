#!/bin/bash
#SBATCH -J 3dino-inference-ds989
...
# =========================
# Inference: Dataset989_EMPIAR_10989 (binary, 2-class)
...
DATALIST_FILE="/cluster/projects/bwanggroup/reza/projects/cryoet/experiments/Dataset989_EMPIAR_10989_transposed_patches512_100_datalist.json"
DATASET_NAME="Dataset989_EMPIAR_10989_transposed"
NUM_CLASSES=2
IMAGE_SIZE=112
BATCH_SIZE=2
OVERLAP=0.75
