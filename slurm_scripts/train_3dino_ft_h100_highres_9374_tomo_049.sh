#!/bin/bash
#SBATCH -J 3dino-ft-h100hr-9374-tomo-049
...
# Tomogram-level NIfTI training (no pre-extracted patches)
# Frozen ViT + UNETR decoder, Dataset049 (EMPIAR 12049), 6-class
# =========================
...
DATASETS=(
    "Dataset049_EMPIAR_12049_transposed"
    )

for DATASET_NAME in "${DATASETS[@]}"; do

    OUTPUT_DIR="${BASE_OUTPUT_DIR}/ssl3d_run_h100_high_res_training_9374_${DATASET_NAME}"
    ...
    echo "=============================================="
    echo "Starting 3D segmentation fine-tuning (tomogram mode)..."
