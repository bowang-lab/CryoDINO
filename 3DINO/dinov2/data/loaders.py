...
from monai.data import CacheNTransDataset, PersistentDataset, Dataset   
import json
...
def make_dataset_3d(
    *,
    ...
    ## AA CHANGE
    dataset = CacheNTransDataset(datalist, transform=transform, cache_n_trans=4, cache_dir=cache_path)
...
def make_segmentation_dataset_3d(
    ...
    ## AA CHANGES
        ...
        input_channels = 1
        # Binary segmentation for EMPIAR 10989 and CZII 10010, 4-class for CZII 10001
